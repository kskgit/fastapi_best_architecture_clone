...
async def generate_path(pk: Annotated[int, Path(description='Business ID')]) -> ResponseSchemaModel[list[str]]:
...
@router.post(
    ...
    description='File disk write, please operate with caution',
    dependencies=[
